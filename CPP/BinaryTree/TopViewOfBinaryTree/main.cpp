...
//Approach 1: Function to print Top View of a binary tree using a iterative approach.
vector<int> topView(Node *root) {
    ...
    // Create a map to store top view nodes by horizontal distance.
    map<int, int> mp;
    ...
    while(!q.empty()) {
        ...
        // Check if the current horizontal distance is not in the map (first node encountered at this distance).
...
int main() {
    ...
    cout<<"The Top View Of Binary Tree: "<<endl;
